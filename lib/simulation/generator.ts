...
const DESCRIPTION_TEMPLATES: Record<ReportCategory, string[]> = {
  garbage: [
    "פח אשפה מלא ברחוב",
    "אשפה מפוזרת בגן ציבורי",
    "פח שבור וזקוק להחלפה בחזית בנייה",
    "הצטברות פסולת ליד מכולה ציבורית",
    "פח לא רוקן כבר מספר ימים בפארק",
    "ריח רע מפח האשפה בכיכר העיר",
    "פסולת בניין מושלכת ברחוב",
    "שקיות אשפה מחוץ לפח בתחנת אוטובוס",
  ],
  lighting: [
    "עמוד תאורה לא עובד ברחוב הראשי",
    "תאורת רחוב מהבהבת בפארק",
    "נורה שרופה בעמוד על הכביש",
    "חושך באזור ציבורי בגלל תאורה לקויה",
    "עמוד תאורה נפל בגן הציבורי",
    "תאורה חלשה מאוד בדרך הולכי רגל",
    "כבל תאורה חשוף ברחוב",
    "פנס רחוב שבור בתחנת אוטובוס",
  ],
  tree: [
    "עץ נפל על המדרכה בחזית הבנייה",
    "ענף גדול עומד ליפול בגן הציבורי",
    "עץ חולה וזקוק לטיפול ברחוב",
    "שורשים פורצים מהמדרכה הציבורית",
    "עץ חוסם את הנוף לנהגים בכביש",
    "עלים יבשים מסוכנים בפארק",
    "עץ גבוה ליד קווי חשמל על הרחוב",
    "צורך בגיזום דחוף בשטח ציבורי",
  ],
  hazard: [
    "בור במדרכה הציבורית",
    "מכסה ביוב פתוח ברחוב",
    "מעקה שבור בגן הציבורי",
    "מדרגות מסוכנות בתחנת אוטובוס",
    "ספסל שבור בגינה הציבורית",
    "זכוכיות שבורות על המדרכה",
    "מפגע בטיחותי ליד בית ספר",
    "מעבר חצייה לא מסומן בכביש",
  ],
  animal: [  
    "כלב מסוכן משוטט ברחוב",
    "חתול פצוע זקוק לעזרה בגן הציבורי",
    "עוף בר פצוע בפארק העיר",
    "נחש נראה בסמוך למדרכה",
    "עכברושים נראים בפארק הציבורי",
  ],
maintenance: [
  "שביל אופניים שבור ומהווה סכנה לרוכבים",
  "ספסל ציבורי שבור בגן הציבורי",
  "מדרכה סדוקה עם סכנת נפילה",
  "שלט רחוב חסר או פגום",
  "מתקן משחקים מקולקל בגן ילדים",
],

pest: [
  "חולדות באזור פחי אשפה ציבוריים",
  "ג'וקים בבניין ציבורי",
  "נחילי יתושים באזור עם מים עומדים",
  "עכברים במקלט ציבורי",
  "בעיה חוזרת של מזיקים בחצר בית ספר",
],
};
